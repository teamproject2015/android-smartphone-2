...
public class SensorManagerActivity extends BaseActivity implements SensorEventListener {
    ...
    protected boolean recordTouchEvent(MotionEvent event,String key,boolean keyCheck) {
        ...
        keyStroke.append("Gravity").append(",").append(gravity[0]).append(",").append(gravity[1]).append(",").append(gravity[2]).append("\r\n");
        ...
        keyStroke.append(tempBuffer).append("Acceleration").append(",").append(linear_acceleration[0]).append(",")
        ...
        keyStroke.append(tempBuffer).append("GyroScope").append(",").append(deltaRotationVector[0]).append(",")
        ...
        //Keystroke for Light
        keyStroke.append(tempBuffer).append("Light").append(",").append(lux).append("\r\n");
        //Keystroke for pressure
        keyStroke.append(tempBuffer).append("Pressure").append(",").append(hPa).append("\r\n");
